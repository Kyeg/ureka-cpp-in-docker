...
TEST(TestFlow8, AttakerForgeToApplyUticket) {
    ...
    string generated_u_ticket_json = cloud_server_atk.msg_generator->self_generate_xxx_u_ticket(generated_request3.dump());
    ...
    bool res1 = iot_device.shared_data->result_message.find("-> FAILURE: SELF_VERIFY_ISSUER_SIGNATURE_ON_U_TICKET") != std::string::npos;
