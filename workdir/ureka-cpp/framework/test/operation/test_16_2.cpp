...
TEST(TestFlow16, TestFailWhenForgeHmacAndApplyTheUtoken) {
    ...
    json temp;
    temp["SAY-HELLO-1"] = "allow";
    temp["SAY-HELLO-2"] = "allow";
    temp["SAY-HELLO-3"] = "allow";
    ...
    cloud_server_atk.shared_data->device_table[target_device_id] = OtherDevice(target_device_id, intercepted_uticket, "", 2);
    cloud_server_atk.shared_data->current_session.current_device_id = target_device_id;
    cloud_server_atk.shared_data->current_session.current_session_key_str = "TkVqlRZLmNoBwaso0I04jwMFPEIT0kQu1hJZWK9S90E=";
    cloud_server_atk.shared_data->current_session.iv_cmd = cloud_server_ep.shared_data->current_session.iv_cmd;

    generated_command = "HELLO-2";
    cout << "line 97\n";
    cloud_server_atk.flow_issue_u_token->holder_send_cmd(target_device_id, generated_command);
    cout << "line 99\n";
    iot_device.msg_receiver->recv_xxx_message();
    cout << "line 101\n";
    ...
    try {
        ...
        string error_message = "-> FAILURE: VERIFY_RESULT";
